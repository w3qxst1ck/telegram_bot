...
def key_description() -> str:
    """Предложение придумать имя ключу"""
    message = "Напишите <b>название ключа</b>, например \"Телефон\" или \"Компьютер\"\n" \
              "Название ключа может быть любое, оно будет видно только вам\n\n" \
              "Если вы нажмете \"Пропустить\", название будет заполнено автоматически"
    return message